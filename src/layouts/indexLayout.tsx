 ...
 * @LastEditors  : Pear107
 * @LastEditTime : 2023-01-30 11:58:54
...
const items: MenuProps["items"] = [
  {
    label: (
      <Link className="flex items-center gap-1" href="/setting">
        <SettingOutlined /> <span>设置信息</span>
      </Link>
    ),
    key: "0",
  },
...
const menuItems = [
  ...
  {
    key: "2",
    label: <Link href="/userInfo">首页</Link>,
  },
  {
    key: "3",
    label: <Link href="/clockRecord">首页</Link>,
  },
];
